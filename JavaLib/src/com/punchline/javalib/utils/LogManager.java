...
public final class LogManager {
	...
	//region INIT
	/**
	 * Initializes the logger with a specific logType under which specific logs function.
	 * @param application The application in which the Logger will run.
	 * @param lT The maximum LogType that the application will print. (NONE -> ERROR -> INFO -> DEBUG);
	 */
	...
	/**
	 * Logs a message of a specific LogType to a registered (or to be registered) log in the Logger.
	 * @param logName The name of the log to which the message will be sent.
	 * @param logType The type of the log message to be sent.
	 ...
	 * @param logName The log to send the info message.
	 * @param message The message to send the log.
	 */
	 ...
	 * @param logName The log to send the debug message.
	 * @param message The message to send the log.
	 */
	 ...
	 * @param logName The log to send the error message.
	 * @param message The message to send the log.
	 */
