 ...
 * to tag, group, and type for easy access.
 * 
 * @author Natman64
 * 
 */
public class EntityManager extends Pool<Entity> {
	...
	/**
	 * Contains all entities that have been added in this iteration of the game
	 * loop.
	 */
	private Array<Entity> newEntities = new Array<Entity>();

	/**
	 * Contains all entities that have been changed in this iteration of the
	 * game loop.
	 */
	private Array<Entity> changedEntities = new Array<Entity>();

	/**
	 * Contains all entities that have been removed in this iteration of the
	 * game loop.
	 */
	...
	/**
	 * Checks for {@link Entity Entities} that have been marked for removal, and
	 * adds them to the removal list.
	 */
	public void process() {
	...
	/**
	 * @return Entities that have been changed in this iteration of the game
	 *         loop.
	 */
	...
	/**
	 * @return Entities that have been deleted in this iteration of the game
	 *         loop.
	 */
