...
public class EntitySpawner implements Component {
	 ...
	 * 
	 * @param spawnTemplate
	 *            The tag of the entity template that will be used to spawn
	 *            children entities.
	 * @param group
	 *            Whether the template is a group template.
	 * @param spawnDelay
	 *            The delay/rate at which entities are created from the
	 *            template.
	 * @param args
	 *            The arguments for the template.
	 */
	public EntitySpawner(String spawnTemplate, boolean group, float spawnDelay,
			Object... args) {
	 ...
	 * 
	 * @param delta
	 *            The world-delta time in seconds.
