...
/**
 * Data structure containing all of the necessary information to create an
 * {@link Entity}.
 * 
 * @author Natman64
 * 
...
public final class EntityCreationArgs {
	 ...
	 * 
	 * @param templateTag
	 *            The tag of the template that should be used.
	 * @param groupTemplate
	 *            Whether the template that should be used is a group template.
	 * @param args
	 *            The arguments for creating the Entity.
	 */
	public EntityCreationArgs(String templateTag, boolean groupTemplate,
			Object... args) {
